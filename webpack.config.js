...
/* Se añade el soporte para el plugin css-minimizer-webpack-plugin */
const CssMinimizerPlugin = require('css-minimizer-webpack-plugin');

/* Se añade el soporte para el plugin terser-webpack-plugin */
...
/* se debe añadir una constante en la cual se va a traer un elemento en este caso es 
   {CleanWebpackPlugin} y se trae el elemento con el método require y internamente se 
   le pasa el plugin clean-webpack-plugin */
...
module.exports = {//Creacion de un objeto, en donde le vamos a añadir todas 
  ...
  plugins: [//Se crea un arreglo e interna mente se deben añadir los plugins que estamos utilizando
    ...
    /* Creacion de una nueva instancia para limpiar el proyecto cuando se ejecute webpack en modo produccion */
    new CleanWebpackPlugin(),
  ],

   /*  Creacion de una nueva instancia para añadir el soporte de optimizacion con lo que viene siendo
       CSS y tercer para lo que viene siendo JavaScript*/
  optimization: {
    minimize: true,
    minimizer: [//Se crea un arreglo en el cual se crea la instansiacion a los recursos plugins y asi poderlo utilizar dentro del proyecto
